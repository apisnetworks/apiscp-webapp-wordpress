<?php declare(strict_types=1);
	...
	class Wordpress_Module extends \Module\Support\Webapps
	{
		...
		public function install(string $hostname, string $path = '', array $opts = array()): bool
		{
			...
			Wpcli::instantiateContexted($this->getAuthContext())->setConfiguration(['apache_modules' => ['mod_rewrite']]);
			...
			return info('%(app)s installed - confirmation email with login info sent to %(email)s', ['app' => static::APP_NAME, 'email' => $opts['email']]);
		}
